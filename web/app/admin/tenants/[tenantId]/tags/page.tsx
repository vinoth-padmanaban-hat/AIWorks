...
export default async function TenantTagsPage({
  params,
}: {
  ...
  try {
    ...
    meta = o;
    rows = await apiGet<unknown[]>(`/admin/tenants/${tenantId}/tags`);
  } catch (e) {
  ...
  return (
    <div>
      ...
      <h2 className="font-display mb-2 text-2xl font-light text-ink">Tags</h2>
