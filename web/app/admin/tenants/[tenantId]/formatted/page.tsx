...
export default async function TenantFormattedPage({
  params,
}: {
  ...
  try {
    ...
    meta = o;
    rows = await apiGet<unknown[]>(
      `/admin/tenants/${tenantId}/formatted-articles?limit=50`,
    );
  } catch (e) {
  ...
  return (
    <div>
      ...
      <h2 className="font-display mb-2 text-2xl font-light text-ink">Formatted articles</h2>
